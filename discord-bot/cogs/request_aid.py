...
class RequestAid(commands.Cog):
    """
    Cog for /request-aid command.
    
    Allows users to request military aid funds with proof.
    """
    
    def __init__(self, bot: commands.Bot, roblox_api, command_logger):
        """
        Initialize RequestAid cog.
    ...
    async def request_aid(
        ...
        """
        Handle /request-aid command.
        
        Args:
            interaction: Discord interaction
            fundsneeded: Amount of funds needed
            proof: URL to proof or None if attachment provided
        """
        ...
        try:
            ...
            # Determine proof URL (from parameter or attachment)
            proof_url = None
